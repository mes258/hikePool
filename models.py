...
def create_car(date, destination, name, phone, location, passengerNum):
    ...
    print(passengerNum)
    if passengerNum == '0':
        cur.execute('insert into cars (date, destination, driverName, driverPhone, driverLocation, numberOfPassengers, passengerOneName, passengerTwoName, passengerThreeName, passengerFourName, passengerFiveName, passengerSixName, passengerOnePhone, passengerTwoPhone, passengerThreePhone, passengerFourPhone, passengerFivePhone, passengerSixPhone) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (date, destination, name, phone, location, passengerNum, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', ' ',' ',' ',' ',' ',' '))
    elif passengerNum == '1':
        cur.execute('insert into cars (date, destination, driverName, driverPhone, driverLocation, numberOfPassengers, passengerTwoName, passengerThreeName, passengerFourName, passengerFiveName, passengerSixName, passengerTwoPhone, passengerThreePhone, passengerFourPhone, passengerFivePhone, passengerSixPhone) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (date, destination, name, phone, location, passengerNum, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', '', '', '', '', ''))
    elif passengerNum == '2':
        cur.execute('insert into cars (date, destination, driverName, driverPhone, driverLocation, numberOfPassengers, passengerThreeName, passengerFourName, passengerFiveName, passengerSixName, passengerThreePhone, passengerFourPhone, passengerFivePhone, passengerSixPhone) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (date, destination, name, phone, location, passengerNum, 'N/A', 'N/A', 'N/A', 'N/A','','','',''))
    elif passengerNum == '3':
        cur.execute('insert into cars (date, destination, driverName, driverPhone, driverLocation, numberOfPassengers, passengerFourName, passengerFiveName, passengerSixName, passengerFourPhone, passengerFivePhone, passengerSixPhone) values(?,?,?,?,?,?,?,?,?,?,?,?)', (date, destination, name, phone, location, passengerNum, 'N/A', 'N/A', 'N/A','','',''))
    elif passengerNum == '4':
        cur.execute('insert into cars (date, destination, driverName, driverPhone, driverLocation, numberOfPassengers, passengerFiveName, passengerSixName, passengerFivePhone, passengerSixPhone) values(?,?,?,?,?,?,?,?,?,?)', (date, destination, name, phone, location, passengerNum, 'N/A', 'N/A','',''))
    elif passengerNum == '5':
        cur.execute('insert into cars (date, destination, driverName, driverPhone, driverLocation, numberOfPassengers, passengerSixName, passengerSixPhone) values(?,?,?,?,?,?,?,?)', (date, destination, name, phone, location, passengerNum, 'N/A',''))
    else:
